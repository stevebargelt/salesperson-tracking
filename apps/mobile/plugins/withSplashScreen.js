import { withStringsXml, AndroidConfig, withAndroidStyles } from "expo/config-plugins";
/**
 *
 ...
 */
export const withSplashScreen = (config) => {
 ...
 */
const withCustomStringsXml = (config) => withStringsXml(config, (modConfig) => {
 ...
 */
const withCustomStylesXml = (config) => withAndroidStyles(config, async (modConfig) => {
...
//# sourceMappingURL=withSplashScreen.js.map