 ...
 */
export function DrawerIconButton(props) {
    ...
    return (<AnimatedPressable {...PressableProps} style={[$container, animatedContainerStyles]}>
...
//# sourceMappingURL=DrawerIconButton.js.map