...
const $centeredOneThirdCol = {
    width: "33.33333%",
    alignItems: "center",
    justifyContent: "center",
};
const $centeredText = ({ spacing }) => ({
    textAlign: "center",
    width: "100%",
...
export const DemoToggle = {
    ...
    data: ({ theme, themed }) => [
      ...
      <DemoDivider size={24}/>
      <ControlledRadio value labelTx="demoShowroomScreen:demoViaSpecifiedTxProp" labelTxOptions={{ prop: "label" }} helperTx="demoShowroomScreen:demoViaSpecifiedTxProp" helperTxOptions={{ prop: "helper" }}/>
      <DemoDivider size={24}/>
      ...
      <DemoDivider size={24}/>
      <ControlledSwitch value accessibilityMode="text" labelTx="demoToggle:useCase.passingContent.useCase.switch.label" status="error" helperTx="demoToggle:useCase.passingContent.useCase.switch.helper"/>
      <DemoDivider size={24}/>
      ...
      <ControlledCheckbox containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 50,
                height: 50,
                backgroundColor: theme.colors.palette.accent300,
                borderColor: theme.colors.palette.accent500,
            }}/>
      <ControlledRadio containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 50,
                height: 50,
                borderRadius: 25,
                backgroundColor: theme.colors.palette.accent300,
      ...
      <ControlledSwitch containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 70,
                height: 50,
                borderRadius: 25,
                backgroundColor: theme.colors.palette.accent300,
      ...
      <ControlledCheckbox value containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 50,
                height: 50,
                backgroundColor: theme.colors.palette.accent300,
                borderColor: theme.colors.palette.accent500,
      ...
      <ControlledRadio value containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 50,
                height: 50,
                borderRadius: 25,
                backgroundColor: theme.colors.palette.accent300,
      ...
      <ControlledSwitch value containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 70,
                height: 50,
                borderRadius: 25,
                backgroundColor: theme.colors.palette.accent300,
      ...
      <ControlledCheckbox value icon="ladybug" containerStyle={$centeredOneThirdCol} inputOuterStyle={{
                width: 50,
                height: 50,
                backgroundColor: theme.colors.palette.accent300,
                borderColor: theme.colors.palette.accent500,
      ...
      <View style={{ width: "100%" }}>
        <ControlledRadio value labelTx="demoToggle:useCase.styling.labelTx" LabelTextProps={{ size: "xs", weight: "bold" }} status="error" labelStyle={{
      ...
      <View style={{ width: "100%" }}>
        <ControlledRadio value labelPosition="left" containerStyle={{ padding: 10, backgroundColor: theme.colors.error }} labelTx="demoToggle:useCase.styling.styleContainer" status="error" labelStyle={{ color: theme.colors.palette.neutral100 }}/>
      </View>
    </DemoUseCase>,
    ],
};
//# sourceMappingURL=DemoToggle.js.map