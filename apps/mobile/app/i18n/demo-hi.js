export const demoHi = {
    demoIcon: {
        description: "एक पंजीकृत आइकन को रेंडर करने के लिए एक कंपोनेंट। यदि `onPress` प्रदान किया जाता है तो यह <TouchableOpacity /> में लपेटा जाता है, अन्यथा <View /> में।",
        useCase: {
            icons: {
                name: "आइकन",
    ...
    demoTextField: {
        ...
        useCase: {
            statuses: {
                name: "स्थितियाँ",
                description: "एक स्थिति प्रॉप है - अन्य कंपोनेंट्स में `preset` के समान, लेकिन कंपोनेंट की कार्यक्षमता को भी प्रभावित करता है।",
                noStatus: {
    ...
    demoToggle: {
        ...
        useCase: {
            variants: {
                name: "विविधताएँ",
                description: "कंपोनेंट कुछ अलग-अलग विविधताओं का समर्थन करता है। यदि किसी विशिष्ट विविधता के भारी अनुकूलन की आवश्यकता है, तो इसे आसानी से पुनर्गठित किया जा सकता है। डिफ़ॉल्ट `checkbox` है।",
                checkbox: {
    ...
    demoButton: {
        description: "एक कंपोनेंट जो उपयोगकर्ताओं को कार्रवाई करने और विकल्प चुनने की अनुमति देता है। Text कंपोनेंट को Pressable कंपोनेंट के साथ लपेटता है।",
        useCase: {
            presets: {
                name: "प्रीसेट",
            ...
            passingContent: {
                ...
                multiLine: "मल्टीलाइन - consequat veniam veniam reprehenderit. Fugiat id nisi quis duis sunt proident mollit dolor mollit adipisicing proident deserunt.",
            },
            styling: {
                name: "स्टाइलिंग",
                description: "कंपोनेंट को आसानी से स्टाइल किया जा सकता है।",
            ...
            disabling: {
                name: "अक्षम करना",
                description: "कंपोनेंट को अक्षम किया जा सकता है और उसके आधार पर स्टाइल किया जा सकता है। दबाने का व्यवहार अक्षम हो जाएगा।",
                standard: "अक्षम - मानक",
    ...
    demoCard: {
        description: "कार्ड संबंधित जानकारी को एक संयमित तरीके से प्रदर्शित करने के लिए उपयोगी हैं। यदि एक ListItem सामग्री को क्षैतिज रूप से प्रदर्शित करता है, तो एक कार्ड का उपयोग सामग्री को लंबवत रूप से प्रदर्शित करने के लिए किया जा सकता है।",
        useCase: {
            presets: {
                name: "प्रीसेट",
                description: "कुछ पूर्व-कॉन्फ़िगर किए गए प्रीसेट हैं।",
            ...
            customComponent: {
                ...
                description: "किसी भी पूर्व-कॉन्फ़िगर किए गए कंपोनेंट को आपके अपने कंपोनेंट से बदला जा सकता है। आप अतिरिक्त कंपोनेंट भी जोड़ सकते हैं।",
    ...
    demoText: {
        ...
        useCase: {
            presets: {
                name: "प्रीसेट",
                description: "कुछ पूर्व-कॉन्फ़िगर किए गए प्रीसेट हैं।",
                default: "डिफ़ॉल्ट प्रीसेट - Cillum eu laboris in labore. Excepteur mollit tempor reprehenderit fugiat elit et eu consequat laborum.",
            ...
            passingContent: {
                name: "सामग्री पास करना",
                description: "सामग्री पास करने के कई तरीके हैं।",
                viaText: "`text` प्रॉप के माध्यम से - Billum in aute fugiat proident nisi pariatur est. Cupidatat anim cillum eiusmod ad. Officia eu magna aliquip labore dolore consequat.",
    ...
    demoHeader: {
        ...
        useCase: {
            ...
            customActionComponents: {
                ...
                description: "यदि आइकन या टेक्स्ट विकल्प पर्याप्त नहीं हैं, तो आप अपना खुद का कस्टम एक्शन कंपोनेंट पास कर सकते हैं।",
                customLeftActionTitle: "कस्टम बायाँ एक्शन",
            },
            titleModes: {
                name: "शीर्षक मोड",
                description: "शीर्षक को मध्य में रहने के लिए मजबूर किया जा सकता है (डिफ़ॉल्ट) लेकिन यदि यह बहुत लंबा है तो काटा जा सकता है। वैकल्पिक रूप से आप इसे एक्शन बटनों के अनुसार समायोजित कर सकते हैं।",
    ...
    demoEmptyState: {
        description: "जब प्रदर्शित करने के लिए कोई डेटा नहीं है तो उपयोग करने के लिए एक कंपोनेंट। इसका उपयोग उपयोगकर्ता को अगला क्या करना है, यह निर्देशित करने के लिए किया जा सकता है।",
        useCase: {
            presets: {
                name: "प्रीसेट",
                description: "आप विभिन्न टेक्स्ट/छवि सेट बना सकते हैं। एक पूर्व-परिभाषित है जिसे `generic` कहा जाता है। ध्यान दें, कोई डिफ़ॉल्ट नहीं है यदि आप पूरी तरह से कस्टम EmptyState चाहते हैं।",
            },
            passingContent: {
                name: "सामग्री पास करना",
                description: "सामग्री पास करने के कई तरीके हैं।",
...
//# sourceMappingURL=demo-hi.js.map